...
**Express C** — Single-threaded C HTTP/1.1 request engine.

**UN1T Auth Service** — Stateless JWT-based authentication microservice in Go.

**UN1T Scheduler** — A task scheduler written in Rust that uses DynamoDB and AWS SQS.

---

## [Micro Projects](https://github.com/DuncanLynch/Impl_Practice) (C++)

**Thread Pool** — Fixed-size worker pool with synchronized task queue.

**Arena Allocator** — Linear allocator optimized for locality and bulk deallocation.

**LRU Cache** — O(1) hash map + linked list eviction design.
...
<p align="left">
<a href="https://github.com/DuncanLynch" target="blank"><img align="center" src="https://raw.githubusercontent.com/rahuldkjain/github-profile-readme-generator/master/src/images/icons/Social/github.svg" alt="DuncanLynch" height="30" width="40" /></a>
<a href="https://linkedin.com/in/linkedin.com/in/duncantlynch" target="blank"><img align="center" src="https://raw.githubusercontent.com/rahuldkjain/github-profile-readme-generator/master/src/images/icons/Social/linked-in-alt.svg" alt="linkedin.com/in/duncantlynch" height="30" width="40" /></a>
</p>
